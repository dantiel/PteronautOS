...
#define RP2040_TINY_BRIDGE_UART_NUM_DEFAULT  0    // same UART0 as runtime
#define RP2040_TINY_BRIDGE_TX_PIN_DEFAULT    0    // UART0 TX → EP2 RX
#define RP2040_TINY_BRIDGE_RX_PIN_DEFAULT    1    // UART0 RX ← EP2 TX
...
#define RP2040_TINY_RX_PWR_PIN_DEFAULT       6    // P-MOSFET gate (LOW = receiver powered); define RX_PWR_MANUAL 1 to skip the MOSFET
...
#define S3_WAVESHARE_BRIDGE_RX_PIN_DEFAULT   44   // same UART as runtime
#define S3_WAVESHARE_BRIDGE_TX_PIN_DEFAULT   43
...
/* ── Waveshare RP2040-Zero — its own profile (shares the Tiny pinout) ── */
#define RP2040_ZERO_CRSF_UART_NUM_DEFAULT    RP2040_TINY_CRSF_UART_NUM_DEFAULT
#define RP2040_ZERO_CRSF_TX_PIN_DEFAULT      RP2040_TINY_CRSF_TX_PIN_DEFAULT
#define RP2040_ZERO_CRSF_RX_PIN_DEFAULT      RP2040_TINY_CRSF_RX_PIN_DEFAULT
#define RP2040_ZERO_CRSF_BAUD_DEFAULT        RP2040_TINY_CRSF_BAUD_DEFAULT
#define RP2040_ZERO_BRIDGE_UART_NUM_DEFAULT  RP2040_TINY_BRIDGE_UART_NUM_DEFAULT
#define RP2040_ZERO_BRIDGE_TX_PIN_DEFAULT    RP2040_TINY_BRIDGE_TX_PIN_DEFAULT
#define RP2040_ZERO_BRIDGE_RX_PIN_DEFAULT    RP2040_TINY_BRIDGE_RX_PIN_DEFAULT
#define RP2040_ZERO_BRIDGE_BAUD_DEFAULT      RP2040_TINY_BRIDGE_BAUD_DEFAULT
#define RP2040_ZERO_SERVO_PIN_1_DEFAULT      RP2040_TINY_SERVO_PIN_1_DEFAULT
#define RP2040_ZERO_SERVO_PIN_2_DEFAULT      RP2040_TINY_SERVO_PIN_2_DEFAULT
#define RP2040_ZERO_SERVO_PIN_3_DEFAULT      RP2040_TINY_SERVO_PIN_3_DEFAULT
#define RP2040_ZERO_SERVO_PIN_4_DEFAULT      RP2040_TINY_SERVO_PIN_4_DEFAULT
#define RP2040_ZERO_SERVO_PIN_5_DEFAULT      RP2040_TINY_SERVO_PIN_5_DEFAULT
#define RP2040_ZERO_SERVO_PIN_6_DEFAULT      RP2040_TINY_SERVO_PIN_6_DEFAULT
#define RP2040_ZERO_SERVO_PIN_7_DEFAULT      RP2040_TINY_SERVO_PIN_7_DEFAULT
#define RP2040_ZERO_SERVO_PIN_8_DEFAULT      RP2040_TINY_SERVO_PIN_8_DEFAULT
#define RP2040_ZERO_RX_BOOT_PIN_DEFAULT      RP2040_TINY_RX_BOOT_PIN_DEFAULT
#define RP2040_ZERO_RX_PWR_PIN_DEFAULT       RP2040_TINY_RX_PWR_PIN_DEFAULT
#define RP2040_ZERO_GYRO_SDA_PIN_DEFAULT     RP2040_TINY_GYRO_SDA_PIN_DEFAULT
#define RP2040_ZERO_GYRO_SCL_PIN_DEFAULT     RP2040_TINY_GYRO_SCL_PIN_DEFAULT
#define RP2040_ZERO_RGB_LED_PIN_DEFAULT      RP2040_TINY_RGB_LED_PIN_DEFAULT
