...
#define RX_PWR_MANUAL  1          // no P-MOSFET — MEDITATION holds BOOT low persistently, bridge stays transparent; power-cycle the EP2 to drop it into the ROM bootloader
